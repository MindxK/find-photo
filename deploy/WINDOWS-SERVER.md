...
ระบบหลายบัญชีเปิดด้วย `Start-Server.cmd` (ต้องติดตั้ง dependencies ใน `.venv` ก่อน) เว็บไซต์ยังฟังเฉพาะ `127.0.0.1:8765`; Cloudflare Tunnel เปิด HTTPS ให้เข้าจากภายนอก โดยไม่ต้องเปิดพอร์ตเราเตอร์
