...
หน้าผลค้นหาใช้ภาพย่อจาก Google Drive ผ่านเซิร์ฟเวอร์ (หากไม่มีภาพย่อจะย่อจากต้นฉบับ) ขนาดสูงสุด 480px; เมื่อเปิดดูรูปใหญ่ใช้ preview 1600px และการดาวน์โหลดยังเป็นไฟล์ต้นฉบับ แคชภาพตัวอย่างอยู่ใน RAM เท่านั้น แยกบัญชี/ไฟล์/รุ่นภาพ/ขนาด ใช้ซ้ำได้ 120 วินาที จำกัดรวม 64 MB หรือ 256 รายการ ตรวจสิทธิ์ในฐานข้อมูลก่อนใช้แคชทุกครั้ง คิวภาพตัวอย่างรอแบบ asynchronous เพื่อไม่ยึด worker ของ API อื่น รายละเอียด thumbnailLink: https://developers.google.com/workspace/drive/api/reference/rest/v3/files
...
เปิดด้วย `Start-Server.cmd` และหยุดด้วย `Stop-Server.cmd` มีบัญชีเจ้าของ เปิดสมัครสมาชิกโดยไม่ต้องใช้รหัสเชิญ ฐานข้อมูลและ Google Drive แยกตามผู้ใช้ พร้อมคิวสแกนและ HTTPS ผ่าน Tailscale Funnel สำหรับ URL คงที่ หรือ Cloudflare Quick Tunnel สำหรับทดลอง ดูขั้นตอน Google OAuth การเปิดอัตโนมัติ และข้อจำกัดลิงก์ฟรีใน [คู่มือ Windows Server](deploy/WINDOWS-SERVER.md)
